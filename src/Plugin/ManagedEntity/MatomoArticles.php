 ...
 * @ManagedEntityPlugin(
 *   id = "articles",
 *   label = @Translation("页面访问统计"),
 *   weight = 5,
 * )
 */
class MatomoArticles extends ManagedEntityPluginBase {
  ...
  public function buildPage(ManagedEntity $managedEntity, EntityInterface $entity) {
    $view = \Drupal::entityTypeManager()->getViewBuilder($entity->getEntityTypeId())->view($entity, 'matomo_articles');
    return $view;
  }
